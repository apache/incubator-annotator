...
Annotator Subcomponents:

Annotator includes a number of subcomponents with separate copyright notices and
license terms. Your use of the code for the these subcomponents is subject to
the terms and conditions of the following licenses.


For the file packages/fragment/src/fragment.pegjs:

  Copyright (c) 2016 World Wide Web Consortium, (Massachusetts Institute of
  ...
  W3C(R) Software License [1] in the hope that it will be useful, but WITHOUT
